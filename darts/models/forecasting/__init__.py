...
Other Local Models (`LocalForecastingModel <https://unit8co.github.io/darts/userguide/covariates.html#local-forecasting-models-lfms>`__)
    - :class:`~darts.models.forecasting.multivariate_model.MultivariateModel`
...
PyTorch (Lightning)-based Models (`GlobalForecastingModel <https://unit8co.github.io/darts/userguide/covariates.html#global-forecasting-models-gfms>`__)
    ...
    - :class:`~darts.models.forecasting.nf_model.NeuralForecastModel`
...
Conformal Models  (`GlobalForecastingModel <https://unit8co.github.io/darts/userguide/covariates.html#global-forecasting-models-gfms>`__)
    ...
    - :class:`~darts.models.forecasting.conformal_dp_model.ConformalDPModel`
